                    ...
                    <div class="card border-left-primary h-100 floating-step">
                        <div class="card-body">
                            ...
                            <p>
                                ...
                                <strong class="text-gray-800">All Open Tickets</strong> menus. These menus can be found
                                on the left side of your screen in the navigation bar.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="card border-left-primary h-100 floating-step">
                        <div class="card-body">
                            ...
                            <p>
                                Locate the ticket in the table on the <strong class="text-gray-800">Closed Tickets</strong>
                                menu. This menu can be found on the left side of your screen in the navigation bar.
                            </p>
                        </div>
                    </div>
                </div>
