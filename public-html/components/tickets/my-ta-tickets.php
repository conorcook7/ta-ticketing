                                ...
                                <div class="modal-content">
                                 <div class="modal-header">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <textarea placeholder="Please describe how you helped with this ticket..." name="limitedtextarea" class="form-control" id="exampleFormControlTextarea1" rows="5" onKeyDown="limitText(this.form.limitedtextarea,this.form.countdown,1000);" 
                                            onKeyUp="limitText(this.form.limitedtextarea,this.form.countdown,1000);"></textarea>
                                            
                                   </div>
                                   <div class="modal-footer">
                                      <div class="mr-auto">
                                        <span>(Maximum characters: 1000)</span><br>
                                        <span>You have <input readonly type="text" name="countdown" size="3" value="1000"> characters left.</span>
                                       </div>
